...
class PetControllerTests {
    ...
    void testLoadPetWithVisitOwnerNotFound() throws Exception {
        ...
        // Attempts to access any pet-related URL with a non-existent owner ID should result in an Exception
    ...
    void testLoadPetWithVisitPetNotFound() throws Exception {
        ...
        // The controller returns null for "pet", which causes a template error when rendering.
